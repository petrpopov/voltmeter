...
<div class="row">
    ...
    <label id="voltmeterid" style="display: none;">${voltmeterid}</label>
    ...
    <div class="col-md-4">
        ...
        <p class="text-p">
            На работе дедлайн? Жена - злобная сука? Заказчики кидают на деньги? Машина разбита вхлам? Муж изменяет с подругой? Теперь есть легкий и веселый способ пожаловаться друзьям на все это,
        ...
        <p>
            <strong>P.S.</strong> Не ищите здесь смысл, это просто еще один способ увеличения Вселенской Энтропии.
        </p>
    </div>
